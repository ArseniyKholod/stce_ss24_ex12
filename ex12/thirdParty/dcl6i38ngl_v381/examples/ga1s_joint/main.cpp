...
// first-order adjoint mode. It computes the derivative of the
// scalar function y = f(x) with a standard dco/c++ first-order
// adjoint driver (see main). f(x) consists of three parts. First,
// it computes a cosine of the input, then it calls g, and
// afterwards is computes cosine of the output of g and returns
